...
SAVEPATH = '/content/drive/MyDrive/Colab Notebooks/Capstone2/'
WEIGHTDECAY = 5e-4
MOMENTUM = 0.8
BATCHSIZE = 64#128
LR = 0.01
...
def main(brain_teacher_target=None):
    ...
    train_imagenet_dataset = CustomImageNetDataset(csv_file='/content/drive/MyDrive/Colab Notebooks/Capstone2/stimulus_ImageNetTraining.tsv', root_dir='/content/drive/MyDrive/Colab Notebooks/Capstone2/images/', train=True, transform=train_transform)
    test_imagenet_dataset = CustomImageNetDataset(csv_file='/content/drive/MyDrive/Colab Notebooks/Capstone2/stimulus_ImageNetTraining.tsv', root_dir='/content/drive/MyDrive/Colab Notebooks/Capstone2/images/', train=False, transform=train_transform)
...
def train(train_loader, epoch, model, optimizer, criterion, teacher_model=None, brain_teacher=None):
